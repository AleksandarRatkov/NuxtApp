  ...
  <v-container fluid>
    <v-row>
      <v-responsive width="100%">
        <v-col md12 sm12>
          <v-card height="fix-content" elevation="5">
            <v-list-item>
              <v-list-item-avatar>
                <v-img
      ...
      <v-responsive width="100%" v-for="(post, index) in posts" :key="index">
        <v-col md12 sm12>
          <v-card height="fix-content" class="mx-auto" elevation="5">
            <v-list-item>
              <v-list-item-avatar>
                <v-img
...
import { postsCollection, commentsCollection } from "~/plugins/firebase.js";
